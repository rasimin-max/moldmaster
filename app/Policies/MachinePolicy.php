...
class MachinePolicy
{
    ...
    {
        return $user->can('create_machine');
    }
    ...
    {
        return $user->can('update_machine');
    }
    ...
    {
        return $user->can('delete_machine');
    }
    ...
    {
        return $user->can('delete_any_machine');
    }
    ...
    {
        return $user->can('force_delete_machine');
    }
    ...
    {
        return $user->can('force_delete_any_machine');
    }
    ...
    {
        return $user->can('restore_machine');
    }
    ...
    {
        return $user->can('restore_any_machine');
    }
    ...
    {
        return $user->can('replicate_machine');
    }
    ...
    {
        return $user->can('reorder_machine');
    }
}
