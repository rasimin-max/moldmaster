...
use App\Filament\Resources\InboundComponentResource\Pages;
...
class InboundComponentResource extends Resource
{
    protected static ?string $model = \App\Models\StockMovement::class;
    protected static ?string $navigationIcon = 'heroicon-o-arrows-right-left';
    protected static ?string $navigationGroup = 'Transaksi';
    protected static ?string $navigationLabel = 'Barang Masuk Komponen';
    protected static ?string $modelLabel = 'Barang Masuk Komponen';
    protected static ?string $pluralModelLabel = 'Barang Masuk Komponen';
    ...
    {
        return [
            'index' => Pages\ListInboundComponents::route('/'),
            'create' => Pages\CreateInboundComponent::route('/create'),
        ];
    }
