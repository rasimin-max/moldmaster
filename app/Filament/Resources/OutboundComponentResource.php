...
use App\Filament\Resources\OutboundComponentResource\Pages;
...
class OutboundComponentResource extends Resource
{
    protected static ?string $model = \App\Models\StockMovement::class;
    protected static ?string $navigationIcon = 'heroicon-o-arrows-right-left';
    protected static ?string $navigationGroup = 'Transaksi';
    protected static ?string $navigationLabel = 'Barang Keluar Komponen';
    protected static ?string $modelLabel = 'Barang Keluar Komponen';
    protected static ?string $pluralModelLabel = 'Barang Keluar Komponen';
    ...
    {
        return [
            'index' => Pages\ListOutboundComponents::route('/'),
            'create' => Pages\CreateOutboundComponent::route('/create'),
        ];
    }
