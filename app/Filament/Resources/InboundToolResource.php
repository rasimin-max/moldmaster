...
use App\Filament\Resources\InboundToolResource\Pages;
use App\Models\Tool;
...
class InboundToolResource extends Resource
{
    protected static ?string $model = \App\Models\ToolMovement::class;
    protected static ?string $navigationIcon = 'heroicon-o-arrows-right-left';
    protected static ?string $navigationGroup = 'Transaksi';
    protected static ?string $navigationLabel = 'Barang Masuk Alat';
    protected static ?string $modelLabel = 'Barang Masuk Alat';
    protected static ?string $pluralModelLabel = 'Barang Masuk Alat';
    ...
    {
        return [
            'index' => Pages\ListInboundTools::route('/'),
            'create' => Pages\CreateInboundTool::route('/create'),
        ];
    }
