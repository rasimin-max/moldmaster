        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('project_name')
                    ->label('Project')
                    ->options(function () {
                        $fromProjects = \App\Models\Project::pluck('name', 'name')->toArray();
                        $fromMolds = \App\Models\Mold::whereNotNull('project_name')->where('project_name', '!=', '')->distinct()->pluck('project_name', 'project_name')->toArray();
                        return array_merge($fromProjects, $fromMolds);
                    })
                    ->searchable()
                    ->live(),
