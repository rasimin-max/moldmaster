...
class ToolMovementExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('tool.code')->label('Kode Alat'),
            ExportColumn::make('tool.name')->label('Nama Alat'),
    ...
    {
        $body = 'Your tool movement export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
